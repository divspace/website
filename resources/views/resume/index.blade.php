...
@section('content')
  <div id="resume">
    ...
    <p class="resume-contact">
      Scottsdale, AZ <strong>&middot;</strong> <a href="tel:+14803604373">(480) 360-4373</a> <strong>&middot;</strong> <a href="#" data-toggle="modal" data-target="#contact">{{ $email }}</a><span class="hidden-sm-down"> <strong>&middot;</strong> <a href="https://www.linkedin.com/in/divspace">linkedin.com/in/divspace</a></span>
    </p>
